...
#        STOXX Europe 600 constituents (continent + UK). STOXX 600 is
#        the standard pan-European benchmark.
#
#   JP → yfinance across Nikkei 225 top names.
#
#   HK → yfinance across Hang Seng Index constituents.
#
# When we want truly exhaustive global coverage, the upgrade path is a
# third-party provider with a worldwide feed (Finnhub / Financial
# Modeling Prep — both have free API-key tiers).
...
JP_UNIVERSE = [
    ...
    '5020.T', '1605.T', '8802.T', '3382.T', '2914.T', '2502.T', '7269.T',
]
...
# ── EU / JP / HK coverage: yfinance across benchmark index constituents ──
